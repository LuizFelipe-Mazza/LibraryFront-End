    ...
    <>
      <div className="containerAllPage">
        ...
        <div className="cardsPage">
          <div className="cards">
            <span>
              <CreditCardRoundedIcon className="iconPay" /> Parcela em até 10x
              sem Juros
            </span>
          </div>
          <div className="cards2">
            <span>
              <PixRoundedIcon className="iconPay" /> Aceitamos Pix
            </span>
          </div>
          <div className="cards3">
            <span>
              <PaidRoundedIcon className="iconPay" /> Parcelamos sem cartão
            </span>
          </div>
        </div>
        <div className="text">
